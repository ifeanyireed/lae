...
export interface PathWaypoint {
  ...
  type?: 'start' | 'goal' | 'coin' | 'star' | 'shell' | 'pit' | 'question_block' | 'vine' | 'normal' | 'doctype' | 'html_tag' | 'head_tag' | 'title_tag' | 'body_tag' | 'text_tag' | 'heading_tag' | 'paragraph_tag' | 'html' | 'head' | 'title' | 'body' | 'text' | 'heading' | 'paragraph' | 'p_tag' | 'h1_tag' | 'h1' | 'p' | 'doctype_html';
  label?: string;
