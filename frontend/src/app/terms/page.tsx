...
import { FileText, ShieldCheck, Mail, Phone, MapPin, Scale } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans flex flex-col overflow-y-auto w-screen select-text">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        ...
        <section className="text-center space-y-4 pt-4">
          <div className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-300 text-xs sm:text-sm font-bold uppercase tracking-wider">
