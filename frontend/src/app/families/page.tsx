  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen font-sans flex items-center justify-end p-6 sm:p-12 md:p-20 relative overflow-hidden">
        ...
        {/* Public Footer Links */}
        <div className="absolute bottom-4 left-0 right-0 z-20 flex items-center justify-center space-x-3 sm:space-x-5 text-[11px] text-slate-300 md:text-slate-400 font-medium">
          ...
          <span>•</span>
          <Link href="/terms" className="hover:text-amber-300 transition">Terms & Conditions</Link>
        </div>
      </div>
    );
  }
