...
function createAdv(
  ...
  return {
    ...
    levels: levelNames.map((name, i) => ({
      ...
      title: name,
      description: name,
      objective: (worldId === 2 && advId === 1 && i === 0) ? 'Nest the head tag inside the html tag' : name,
      mechanic: (worldId === 2 && advId === 1 && i === 0) ? 'Nest the head tag inside the html tag' : mechanic,
