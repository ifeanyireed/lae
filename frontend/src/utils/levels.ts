  ...
  levels: [
    {
      ...
      bgImage: '/Adventure 1 - Level 1.svg',
    ...
    },
    {
      ...
      bgImage: '/Adventure 1 - Level 2.svg',
    ...
    },
    {
      ...
      mechanic: 'Turning',
      bgImage: '/Adventure 1 - Level 3.svg',
    ...
    },
    {
      ...
      bgImage: '/Adventure 1 - Level 4.svg',
    ...
    },
    {
      ...
      bgImage: '/Adventure 1 - Level 5.svg',
    ...
    },
    {
      ...
      bgImage: '/Adventure 1 - Level 6.svg',
    ...
    },
    {
      ...
      bgImage: '/Adventure 1 - Level 7.svg',
    ...
    },
    {
      ...
      bgImage: '/Adventure 1 - Level 8.svg',
    ...
    },
    {
      ...
      bgImage: '/Adventure 1 - Level 9.svg',
    ...
    },
    {
      ...
      bgImage: '/Adventure 1 - Level 10.svg',
    ...
    },
    {
      ...
      bgImage: '/Adventure 1 - Level 11.svg',
    ...
    },
    {
      ...
      bgImage: '/Adventure 1 - Level 12.svg',
...
export const ADVENTURE_2: AdventureConfig = {
  ...
  levels: [
    ...
    bgImage: `/Adventure 2 - Level ${(i % 12) + 1}.svg`,
    waypoints: LEVEL_1_WAYPOINTS,
    availableBlocks: ['move_forward', 'turn_left', 'turn_right', 'turn_around', 'repeat'],
    maxBlocks: 15,
  })),
...
export const ADVENTURE_3: AdventureConfig = {
  ...
  levels: [
    ...
    bgImage: `/Adventure 3 - Level ${(i % 12) + 1}.svg`,
    waypoints: LEVEL_1_WAYPOINTS,
    availableBlocks: ['move_forward', 'turn_left', 'turn_right', 'turn_around', 'repeat'],
    maxBlocks: 15,
  })),
...
export const ADVENTURE_4: AdventureConfig = {
  ...
  levels: [
    ...
    bgImage: `/Adventure 4 - Level ${(i % 12) + 1}.svg`,
    waypoints: LEVEL_1_WAYPOINTS,
    availableBlocks: ['move_forward', 'turn_left', 'turn_right', 'turn_around', 'repeat'],
    maxBlocks: 15,
  })),
...
export const ADVENTURE_5: AdventureConfig = {
  ...
  levels: [
    ...
    bgImage: `/Adventure 5 - Level ${(i % 12) + 1}.svg`,
    waypoints: LEVEL_1_WAYPOINTS,
    availableBlocks: ['move_forward', 'turn_left', 'turn_right', 'turn_around', 'repeat'],
    maxBlocks: 20,
  })),
